  ...
  firebaseEmailAuth.onAuthStateChanged(function(user) {
    ...
    if (user) {
      ...
      firebaseDatabase.ref("users/" + user.uid).once('value').then(function(snapshot) {
        ...
        // document.getElementById("loginmenu2").textContent = "Log Out";
        // document.getElementById("loginmenu2").href = "/logout.html";
        ...
        if (document.getElementById("titleCheck").textContent == "mypage") {
          ...
          if (snapshot.val().comment) {
            ...
            //없으면 더미 데이터 넣어준다.
            document.getElementById("statetxt").textContent = "자기소개 & 프로필사진 선택";
